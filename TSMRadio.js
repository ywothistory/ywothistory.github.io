...
var genre = "trance";
var currentURL = "https://www.youtube.com/watch?v=LZSnoaLWCVU";
var songlength = 235;
var thisVar = setInterval(function(){refresh();}, songlength*1000+5000);
var newURL = "LZSnoaLWCVU";
var quality = "large";
var boxopen = 0;
var minimized = 0;
...
setSongVars();
clearInterval(thisVar);
thisVar = setInterval(function(){refresh();}, songlength*1000+7000);
}
